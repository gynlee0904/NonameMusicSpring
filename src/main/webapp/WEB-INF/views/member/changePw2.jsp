...
<html lang="en">
    <head>
        ...
        <title>비밀번호 재설정2</title>
        <link rel="stylesheet" href="../resources/css/header.css">
        <link rel="stylesheet" href="../resources/css/nav.css">
        <link rel="stylesheet" href="../resources/css/member/changePw2.css">
                        ...
                        <div id="findBox">
                            ...
                            <div id="box_main">
                                <div class="pass_field">
                                    ...
                                    <div class="input_box">
                                        <input type="password" name="newPw" class="input_field" placeholder="사용하실 비밀번호를 입력하세요">
                                    </div>
                                </div>
                                <div class="pass_field">
                                    <div class="changePw">
